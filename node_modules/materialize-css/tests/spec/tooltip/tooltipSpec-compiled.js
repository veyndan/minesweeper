  ...
  describe('Tooltip opens and closes properly', function () {
    ...
    it('Opens a tooltip on mouse enter', function (done) {
      ...
      setTimeout(function () {
        ...
        expect(tooltip.children('span').text()).toBe('I am tooltip', 'because that is the defined text in the html attribute');
    ...
    it('Positions tooltips smartly on the bottom within the screen bounds', function (done) {
      ...
      setTimeout(function () {
        ...
        expect(offset.top + tooltip.height() <= window.innerHeight).toBeTruthy();
        ...
        expect(offset.top > tooltippedBtn.offset().top + tooltippedBtn.height()).toBeTruthy();
        expect(offset.top < tooltippedBtn.offset().top + tooltippedBtn.height()).toBeFalsy();
        done();
      }, 300);
    });
    ...
    it('Changes position attribute dynamically and positions tooltips on the right correctly', function (done) {
      ...
      setTimeout(function () {
        var offset = tooltip.offset();
        expect(offset.left > tooltippedBtn.offset().left + tooltippedBtn.width()).toBeTruthy();
        done();
      }, 300);
    });
...
//# sourceMappingURL=tooltipSpec-compiled.js.map