...
asyncTest('should pinch and pan simultaneously be recognized when enabled', function () {
    ...
    var executeGesture = function (cb) {
        ...
        touches = [{ clientX: 0, clientY: 10, identifier: 0, target: el }, { clientX: 10, clientY: 10, identifier: 1, target: el }];
        ...
        setTimeout(function () {
            touches = [{ clientX: 10, clientY: 20, identifier: 0, target: el }, { clientX: 20, clientY: 20, identifier: 1, target: el }];
        ...
        setTimeout(function () {
            touches = [{ clientX: 20, clientY: 30, identifier: 0, target: el }, { clientX: 40, clientY: 30, identifier: 1, target: el }];
...
//# sourceMappingURL=test_simultaneous_recognition-compiled.js.map