...
test('inArray', function () {
    ...
    ok($H.inArray([{ id: 2 }, { id: 24 }], '24', 'id') === 1, 'find by key and return the index');
    ok($H.inArray([{ id: 2 }, { id: 24 }], '22', 'id') === -1, 'not found by key and return -1');
});
...
test('uniqueArray', function () {
    deepEqual($H.uniqueArray([{ id: 1 }, { id: 2 }, { id: 2 }], 'id'), [{ id: 1 }, { id: 2 }], 'remove duplicate ids');
});
...
test('assign', function () {
    expect(2);
    deepEqual($H.assign({ a: 1, b: 3 }, { b: 2, c: 3 }), { a: 1, b: 2, c: 3 }, 'Simple extend');
...
//# sourceMappingURL=test_utils-compiled.js.map